    ...
    <section className="min-h-screen flex items-center pt-20 md:pt-24 section-padding">
      <div className="container-custom">
        ...
        >
          ...
          >
            <button className="px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-sm hover:shadow-md flex items-center gap-2">
              Get Started
              <FiArrowRight className="w-4 h-4" />
            </button>
            <button className="px-6 py-3 text-sm font-medium text-[rgb(var(--foreground))] border border-[rgb(var(--border))] rounded-lg hover:bg-[rgb(var(--border))] transition-colors duration-200">
              See Features
            </button>
          </motion.div>
